...
exports.SubsService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let SubsService = class SubsService {
    constructor(subModel) {
        this.subModel = subModel;
    }
    async createSub(email) {
...
SubsService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel('Sub')),
    __metadata("design:paramtypes", [mongoose_2.Model])
], SubsService);
exports.SubsService = SubsService;
//# sourceMappingURL=subs.service.js.map